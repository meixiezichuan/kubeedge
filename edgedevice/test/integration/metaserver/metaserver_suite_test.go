...
func TestEdgecoreMetaServer(t *testing.T) {
	...
	var _ = BeforeSuite(func() {
		...
		c.Modules.MetaManager.MetaServer.TLSCaFile = "/tmp/edgedevice/rootCA.crt"
		c.Modules.MetaManager.MetaServer.TLSCertFile = "/tmp/edgedevice/kubeedge.crt"
		c.Modules.MetaManager.MetaServer.TLSPrivateKeyFile = "/tmp/edgedevice/kubeedge.key"
